...
const translations = {
  en: {
    ...
    hero: {
      ...
      headline1: "Reviews are your",
      headline2: "#1 sales channel.",
      headline3: "Most restaurants ignore them.",
      sub: "Re:view replies in your voice, sends unhappy guests to private feedback, and turns happy ones into 5-star reviews — so you rank higher on Google Maps and get recommended by AI.",
      cta: "Start 14-day free trial",
      trust1: "14-day free trial",
      trust2: "5 min setup",
      trust3: "GDPR compliant",
      pillar1: "Higher Google Maps ranking",
      pillar2: "Recommended by AI models",
      pillar3: "Private feedback for 1–3★",
      mapsBadge: "Top rated nearby",
      aiPrompt: "Best Italian restaurant near Utrecht Centraal?",
      aiReply: "Aimly Utrecht is a strong pick — 4.8★ from 124 reviews. Guests highlight the fresh pasta and warm service. Open until 22:00.",
    },
    hbr: {
  ...
  nl: {
    ...
    hero: {
      badge: "Gemaakt voor de horeca",
      headline1: "Reviews zijn je",
      headline2: "#1 verkoopkanaal.",
      headline3: "De meeste zaken negeren ze.",
      sub: "Re:view reageert in jouw stem, stuurt ontevreden gasten naar private feedback, en verandert tevreden gasten in 5-sterren reviews — zo rank je hoger op Google Maps en word je aanbevolen door AI.",
      cta: "Start 14-daagse proefperiode",
      trust1: "14 dagen gratis",
      trust2: "5 min setup",
      trust3: "AVG compliant",
      pillar1: "Hogere Google Maps ranking",
      pillar2: "Aanbevolen door AI modellen",
      pillar3: "Private feedback voor 1–3★",
      mapsBadge: "Top beoordeeld in de buurt",
      aiPrompt: "Beste Italiaans bij Utrecht Centraal?",
      aiReply: "Aimly Utrecht is een sterke keuze — 4.8★ met 124 reviews. Gasten roemen de verse pasta en gastvrije bediening. Open tot 22:00.",
    },
    hbr: {
