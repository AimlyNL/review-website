...
const translations = {
  en: {
    ...
    hero: {
      ...
      headline1: "Reviews boost",
      headline2: "your business.",
      headline3: "Most owners ignore theirs.",
      sub: "Re:view replies in your voice, routes unhappy guests to private feedback, and turns happy ones into 5★ reviews — so you climb Google Maps and get recommended by AI.",
  ...
  nl: {
    ...
    hero: {
      ...
      headline1: "Reviews maken",
      headline2: "je zaak.",
      headline3: "De meeste eigenaren negeren ze.",
      sub: "Re:view reageert in jouw stem, stuurt ontevreden gasten naar private feedback, en verandert tevreden gasten in 5★ reviews — zo klim je op Google Maps en word je aanbevolen door AI.",
