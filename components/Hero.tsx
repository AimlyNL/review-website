  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-16 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8 flex flex-col items-center text-center">
        ...
        <div className="animate-fade-up inline-flex items-center gap-2.5 bg-white border border-stone-200 shadow-sm text-stone-700 text-xs font-medium px-4 py-2 rounded-full mb-7">
        ...
        {/* Stat pill */}
        <div className="animate-fade-up delay-300 mt-5 inline-flex items-center gap-3 text-sm text-stone-500">
        ...
        {/* CTAs */}
        <div className="animate-fade-up delay-300 mt-8 flex flex-col sm:flex-row items-center gap-3">
          <a
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-0.5">
                            ...
                            <div className="flex gap-0.5">
                              {[1,2,3,4,5].map(s => (
                                <svg key={s} width="8" height="8" viewBox="0 0 12 12" fill={s <= r.stars ? "#f59e0b" : "#e7e5e4"}>
